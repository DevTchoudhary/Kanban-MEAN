                ...
                switch (updateType) {
                    ...
                    case 'update':
                        if (this.parent.enableVirtualization && !this.parent.dataModule.isRemote() && isDropped) {
                            ...
                            promise = this.dataManager.insert(data, this.getTable(), this.getQuery(), this.dataManager.dataSource.json.findIndex((data) => data[this.parent.cardSettings.headerField] === dataDropIndexKeyFieldValue));
                        }
                        else {
                    ...
                    case 'batch':
                        if (!this.parent.dataModule.isRemote() && isDropped && this.parent.enableVirtualization && data) {
                            for (let i = 0; i < data.length; i++) {
                                promise = this.dataManager.remove(this.keyField, data[i], this.getTable(), this.getQuery());
                            }
                            let currentIndex = this.dataManager.dataSource.json.findIndex((data) => data[this.parent.cardSettings.headerField] === dataDropIndexKeyFieldValue);
                            for (let i = 0; i < data.length; i++, currentIndex++) {
                                promise = this.dataManager.insert(data[i], this.getTable(), this.getQuery(), currentIndex);
                            }
                        }
                        else {
